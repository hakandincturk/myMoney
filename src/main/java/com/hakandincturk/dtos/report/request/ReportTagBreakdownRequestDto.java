...
@NoArgsConstructor
@AllArgsConstructor
public class ReportTagBreakdownRequestDto {
  ...
  // Etiket toplama modu dashboard ile aynı semantiğe sahip olsun diye mevcut enum yeniden kullanılır
  private DashboardTagSummarySumMode sumMode = DashboardTagSummarySumMode.DISTRIBUTED;
